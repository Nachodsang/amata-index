  ...
  return (
    <div className="w-full hidden tablet2:hidden flex-col tablet1:flex desktop0:flex ">
      ...
      >
        <input
          type="text"
          className="focus:ring-2 ring-[rgb(2,131,206)] rounded-3xl tablet1:w-full desktop0:w-[25%] mb-4 desktop0:mb-0 w-full border border-gray-300 outline-none px-2 py-1   tablet1:inline desktop0:inline me-4"
          placeholder="filter"
        />
        <input
          type="text"
