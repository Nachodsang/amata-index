        ...
        {model
          ? model.grid.map((itemGrid: IGrid, indexGrid: number) => (
              <div key={indexGrid} className="hover:bg-slate-200">
                ...
                <button
                  type="button"
                  className="hover:bg-primary-600 focus:bg-primary-600 active:bg-primary-700 hidden rounded bg-primary px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)]"
                  data-te-toggle="modal"
                        ...
                        >
                          <div
                            ...
                            onClick={() => {
                              setModelAdd({
                                className:
                                  "grid-cols-1 grid md:grid-cols-1 gap-4",
                                contents: [
                                  {
                                    type: "hr",
                                    className: "",
                          ...
                          <div
                            ...
                            onClick={() => {
                              setModelAdd({
                                className:
                                  "grid lg:grid-cols-2 gap-4 grid-cols-1",
                                contents: [
                                  {
                                    type: "editor",
                                    className: "",
                          ...
                          <div
                            ...
                            onClick={() => {
                              setModelAdd({
                                className:
                                  "grid lg:grid-cols-6 gap-4 grid-cols-1",
                                contents: [
                                  {
                                    type: "editor",
                                    className:
                          ...
                          <div
                            ...
                            onClick={() => {
                              setModelAdd({
                                className:
                                  "grid lg:grid-cols-3 gap-4 grid-cols-1",
                                contents: [
                                  {
                                    type: "editor",
                                    className: "",
                          ...
                          <div
                            ...
                            onClick={() => {
                              setModelAdd({
                                className:
                                  "grid lg:grid-cols-4 gap-4 grid-cols-1",
                                contents: [
                                  {
                                    type: "editor",
                                    className: "",
                                ...
                                contents: [
                                  {
                                    type: "img",
                                    className:
                                      "card-product lg:col-span-1 col-span-3",
                                    url: "",
                                  },
                                  {
                                    type: "editor",
                                ...
                                contents: [
                                  {
                                    type: "img",
                                    className:
                                      "lg:col-span-2 col-span-1 card-product",
                                    url: "",
                                  },
                                  {
                                    type: "img",
                                ...
                                (
                                  ...
                                  >
                                    ...
                                    itemContent.type == "vdo" ? (
                                      <div className="mx-auto">
                                        {itemContent.url &&
                                        itemContent.url.split("http").length >
                                          1 ? (
                                          <iframe
                                            width="420"
                                            height="315"
